...
| OIDC/JWKS test server validation | stable facade workflow | `public-crate-surface-cleanup` | `docs/how-to/test-oidc-jwks-test-server.md`, `examples/external/oidc-test-server-validation/README.md` | `cargo xtask public-surface`; `cargo test -p uselesskey-test-server --all-features`; `cargo xtask external-adoption-smoke --path . --library-examples` | `target/xtask/public-surface/latest.json`, `target/external-adoption-smoke/report.json`, `target/external-adoption-smoke/report.md` | Proves the public OIDC/JWKS test-server crate surface and downstream-style discovery, JWKS, phase-rotation, and cache-header example compile and run, not production IdP behavior, provider compatibility, network security, release readiness, downstream verifier correctness, or production security. |
...
| ECDSA fixture validation | stable facade workflow | `public-crate-surface-cleanup` | `docs/how-to/test-ecdsa-fixtures.md`, `examples/external/ecdsa-fixture-validation/README.md` | `cargo xtask public-surface`; `cargo test -p uselesskey-ecdsa --all-features`; `cargo xtask external-adoption-smoke --path . --library-examples` | `target/xtask/public-surface/latest.json`, `target/external-adoption-smoke/report.json`, `target/external-adoption-smoke/report.md` | Proves the public ECDSA fixture crate surface and downstream-style ES256/ES384 PKCS#8/SPKI parser example compile and run, not production signing security, key custody, provider compatibility, release readiness, downstream verifier correctness, or production security. |
| Ed25519 fixture validation | stable facade workflow | `public-crate-surface-cleanup` | `docs/how-to/test-ed25519-fixtures.md`, `examples/external/ed25519-fixture-validation/README.md` | `cargo xtask public-surface`; `cargo test -p uselesskey-ed25519 --all-features`; `cargo xtask external-adoption-smoke --path . --library-examples` | `target/xtask/public-surface/latest.json`, `target/external-adoption-smoke/report.json`, `target/external-adoption-smoke/report.md` | Proves the public Ed25519 fixture crate surface and downstream-style PKCS#8/SPKI parser example compile and run, not production signing security, key custody, provider compatibility, release readiness, downstream verifier correctness, or production security. |
